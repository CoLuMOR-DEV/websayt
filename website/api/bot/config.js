...
module.exports = async (req, res) => {
  ...
  if (req.method === 'POST') {
    ...
    const update = {
      ...
      classReminderEnabled: body.classReminderEnabled !== undefined ? !!body.classReminderEnabled : undefined,
      newWorkAnnounceEnabled: body.newWorkAnnounceEnabled !== undefined ? !!body.newWorkAnnounceEnabled : undefined,
    };
